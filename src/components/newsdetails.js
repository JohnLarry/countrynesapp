...
export default function NewsDetail(props){
  ...
  let itemId =parseInt(articleId);
    ...
    return( 
        ...
        <Row> <h2>{store.articles[itemId].title}</h2></Row>
        <Row> <Image src={store.articles[itemId].urlToImage} fluid/></Row>
        <Row>
        ...
        <Row><span>{store.articles[itemId].content}</span><a href ={store.articles[itemId].url} target="_blank" rel="noopener noreferrer" >read more </a></Row>
